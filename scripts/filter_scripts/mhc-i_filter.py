...
def top_binders():
    ...
    unique_peptides.to_csv('C:/Users/DELL/Desktop/Programs/Kp-vaccine-pipeline/data/Refined_epitope_values/peptides.csv', index=False, header=['Peptide'])
...
## T-cell MHC-I epitopes are filtered for their top binders
